  ...
  return (
    <main className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="SWAMN deploys autonomous AI bots and self-sealing pods to clean rivers, lakes and harbours for up to 12 hours a day." />
